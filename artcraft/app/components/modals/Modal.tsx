...
const Modal: React.FC<ModalProps> = ({
    ...
    return (
        ...
        '>
                <div className='
            relative w-full md:w-4/6 lg:w3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto 
            '>
                    {/* {Content} */}
                    <div className={`
                translate
               ...
               `}>
                ...
                flex flex-col w-full bg-white outline-none focus:outline-none'>
                            ...
                            {/* Header */}
                            <div
                                className='flex items-center p-3 rounded-t justify-center relative border-b-[1px]'
                            >
                                <button
                                    onClick={handleClose}
